...
De plus, Masix autorise l'exécution simultanée de plusieurs environnements de travail. Il est possible d'exécuter parallèlement sur une m\^eme station des applications Unix, DOS, OS/2, Win32, etc. 
...
\end {itemize}
\figps{masix2}{133mm}{100mm}{Structure du système Masix}
...
le micro-noyau lui-m\^eme en possède une partie, par exemple le temps CPU utilisé par
un {\em thread}.
