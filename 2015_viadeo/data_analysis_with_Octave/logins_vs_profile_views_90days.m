...
title('Distribution of premium members : logins vs profile views (90 days)');
axis([0 10000 0 10000])
print("logins_vs_profile_views_premium_90days.jpg")

figure(2);
scatter(logins_non_premium,profiles_non_premium, 1, 'b')
xlabel('Logins');
ylabel('Profiles views');
title('Distribution of non-premium members : logins vs profile views (90 days)');
axis([0 10000 0 10000])
print("logins_vs_profile_views_non_premium_90days.jpg")
...
xlabel('Logins');
ylabel('Profiles views');
title('Distribution of all members : logins vs profile views (90 days)');
axis([0 10000 0 10000])
print("logins_vs_profile_views_90days.jpg")
...
title('Distribution of premium members : logins vs profile views (90 days)');
axis([0 1000 0 1000])
print("logins_vs_profile_views_premium2_90days.jpg")
...
title('Distribution of non-premium members : logins vs profile views (90 days)');
axis([0 1000 0 1000])
print("logins_vs_profile_views_non_premium2_90days.jpg")
...
title('Distribution of all members : logins vs profile views (90 days)');
axis([0 1000 0 1000])
print("logins_vs_profile_views2_90days.jpg")
