package com.oberthurcs.formation.exercices.server;

import javacard.framework.*;
import com.oberthurcs.formation.filesystem.*;

public class Ex5_Server extends Applet {
	...
	private RootDirectory sharedMasterFile;
...
//	private File currentFile;
	...
	protected Ex5_Server()
	{
		sharedMasterFile = SharedRootDirectory.getInstance();
	...
	{
		if ( ! clientAID.equals(JCSystem.getPreviousContextAID()) ) return null;
		return (Shareable) sharedMasterFile;
	}
	...
	{
		setCurrentFile(sharedMasterFile);
		return true;
	}
